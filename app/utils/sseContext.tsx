import React, { createContext, type ReactNode, useContext, useReducer, useState } from 'react';
...
export const SSEConnectProvider: React.FC<SSEContextProviderProps> = ({ children }) => {
  ...
  const [isNavCollapsed, setIsNavCollapsed] = useState(() => {
    const savedState = typeof window !== 'undefined' ? localStorage.getItem('navCollapsed') : null;
