  ...
  return (
    <div className="flex flex-shrink flex-grow flex-col overflow-x-hidden overflow-y-hidden px-5 py-4">
      <div className="flex h-1/4 flex-row-reverse">
        <div className="mt-4 flex w-2/3 flex-col rounded-lg border border-my-border bg-green-400/60 p-3 dark:border-my-darkborder dark:bg-green-700/80 sm:max-w-[80%] sm:border-2">
      ...
      <div className="flex flex-shrink flex-grow">
        <div className="mt-4 flex w-full flex-col rounded-lg border border-my-border bg-my-bg p-3 dark:border-my-darkborder dark:bg-my-darkbg1 sm:max-w-[80%] sm:border-2">
          <div className="h-[21px] w-1/3 animate-pulse rounded-md bg-gray-400/30"></div>
