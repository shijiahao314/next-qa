...
export default function SideNav() {
  ...
  return (
    <>
      <div
        className={
          'absolute z-30 flex h-full flex-shrink-0 flex-grow-0 transform flex-col justify-between border-my-border bg-my-bg px-4 transition-transform duration-300 dark:border-my-darkborder dark:bg-my-darkbg1 md:relative md:w-52 md:translate-x-0 md:border-r-2 ' +
          `${navOpen ? 'translate-x-0' : '-translate-x-full'}`
        }
      >
        <div className="flex h-max flex-col items-center space-y-10 py-10">
          <UserStatus></UserStatus>
          <div className="flex flex-col items-center justify-between overflow-y-auto py-4">
            <ul className="space-y-2 font-medium " role="menu">
              ...
              <li>
                <a
                  className={`${pathname === '/mdeditor' ? aStyle_active : aStyle}`}
                  href={'/mdeditor'}
                >
