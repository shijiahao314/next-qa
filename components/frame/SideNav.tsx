...
export default function SideNav() {
  ...
  return (
    <>
      <div
        className={
          'absolute z-30 h-full transform border-my-border shadow-[0px_0px_10px_0px_rgba(0,0,0,0.2)] transition-transform duration-300 dark:border-my-darkborder md:relative md:block md:translate-x-0 md:border-r-2 md:shadow-none ' +
