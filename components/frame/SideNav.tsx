...
export default function SideNav() {
  ...
  return (
    <>
      <div
        className={
          'absolute z-30 flex h-full w-48 transform flex-col justify-between border-my-border bg-my-bg px-4 transition-transform duration-300 dark:border-my-darkborder dark:bg-my-darkbg1 md:relative md:translate-x-0 md:border-r-2 ' +
      ...
      >
        ...
        <div className="flex flex-shrink-0 flex-grow-0 flex-row justify-center space-x-2 py-8">
