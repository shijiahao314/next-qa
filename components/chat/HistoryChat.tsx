      ...
      <div className="flex h-full w-full flex-col overflow-y-auto">
        <div className="flex flex-col overflow-x-hidden overflow-y-auto">
          <div className="space-y-3 px-4 py-5">
            {/* 新的聊天 */}
            <div
              className="group border0 bg1 dark:hover:bg-my-dark-bg3 flex w-full cursor-pointer resize-none flex-row items-center justify-center rounded-lg border px-3 py-3 shadow-xs"
              onClick={() => {
            ...
            >
              <div className="h-8 w-8">
                <svg className="text-black/60 dark:text-white/60" viewBox="0 0 1024 1024">
                  <path
